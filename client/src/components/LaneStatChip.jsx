...
export default function LaneStatChip({ lane, stats }) {
  ...
  return (
    <div style={styles.chip}>
      ...
      <div style={{ ...styles.winRate, color }}>{winPct}%</div>
      <div style={styles.stat}>
        <span style={styles.statLabel}>Avg GD</span>
